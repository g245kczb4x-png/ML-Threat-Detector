# ML-Powered Intrusion Prevention System (IPS)

A real-time cybersecurity honeypot and SIEM dashboard that leverages Logistic Regression and Natural Language Processing (NLP) to detect, classify, and automatically terminate malicious attacker sessions.
